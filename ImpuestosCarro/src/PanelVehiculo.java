...
public class PanelVehiculo extends JPanel implements ActionListener
{
	...
	public PanelVehiculo(InterfazImpuestosCarro v)
	{
		...
		df.applyPattern("$ ###,###.##");
		String strPago = df.format(txtValor);
		txtValor.setText(strPago);*/
	...
	public void actionPerformed(ActionEvent evento) {
		...
		if(comando.equals(BUSCAR)) {
			JOptionPane.showMessageDialog(this, "No sirve intenta con el otro :,y", "Calculo de Impuestos", JOptionPane.INFORMATION_MESSAGE);
		}	
	}

...
public class PanelResultados extends JPanel implements ActionListener
{
	...
	public void actionPerformed(ActionEvent evento)
	{
		...
		if(comando.equals(LIMPIAR))
		{
			...
			JOptionPane.showMessageDialog(this, "uff ni este sirve, el otro si a de funcionar :,v", "Calculo de Impuestos", JOptionPane.INFORMATION_MESSAGE);
		}
		else if(comando.equals(CALCULAR))
		{
			//Reaccion al evento de CALCULAR
			JOptionPane.showMessageDialog(this, "Te engañe :v", "Calculo de Impuestos", JOptionPane.INFORMATION_MESSAGE);
		}
	}
